...
window = tk.Tk()
window.title("Thị giác máy tính")
...
lbl = tk.Label(window, text="Nhập ID", width=20, height=2, fg="black", font=('times', 20, 'italic bold '))
...
message = tk.Label(window, text="Thị Giác Máy Tính ", bg="cyan", fg="black", width=50,
...
lbl2 = tk.Label(window, text="Nhập Tên", width=20, fg="black",  height=2, font=('times', 20, 'italic bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, fg="black")
txt2.place(x=550, y=310)

takeImg = tk.Button(window, text="Thêm Ảnh",command=take_img,fg="white", bg="green"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 20, 'italic bold '))
takeImg.place(x=200, y=500)

trainImg = tk.Button(window, text="Đào tạo",fg="white",command=trainimg ,bg="green"  ,width=20  ,height=3, activebackground = "Red",font=('times', 20, 'italic bold '))
